  ...
  return (
    <>
      ...
      <div className='firstContent'>
        <div class="wrapper"><div class='g-esports'/>
          <img src="p.jpg
" 
          />
          <img src="aov.jpg
...
"
        ...
        <div className="gabungan" style={{ display: "flex", flexDirection: "column", zIndex: "1", position: "absolute", }}>
          ...
          <p className='suka'>Pemain profesional maupun talenta baru, kejar mimpimu di panggung kompetisi game persembahan</p>
          <p className='suka1'>Garena</p>
        </div>
      </div>
